...
/**
   ...
   */
const detailQuery = `select rowid "rowid", nik_staff"nik_staff", lang_id "lang_id", lang_oral_val "lang_oral_val", tid"tid", lang_written_val "lang_written_val",inputby "inputby",to_char(inputdate,'dd-mm-yyyy hh24:mi') "inputdate",updateby "updateby",to_char(updatedate,'dd-mm-yyyy hh24:mi') "updatedate" 
from hr_language where nik_staff = :nik_staff`

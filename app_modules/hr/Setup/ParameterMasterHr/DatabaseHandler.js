...
from parameter where upper(controlsystem) = 'HR' and
(parametercode LIKE  UPPER('%' || :search ||'%') OR parametername LIKE UPPER('%' || :search ||'%')) order by parametercode DESC`
...
updateby  "updateby",
to_char(updatedate,'dd-mm-yyyy hh24:mi') "updatedate",
uom "uom#code", uom "uom#description"
 FROM parametervalue

...
async function getDetailLimit(req, res, next) {
    ...
    const last_date = _.maxBy(checkEntry.rows, function (o) { return o.workdate_date.getDate() })

    const dateList = _.map(checkEntry.rows, function (o) { return o.workdate })
    ...
    if (checkEntry?.rows[0]?.entries > 99) {
        ...
        _.set(binds, 'periodone', last_date.workdate)
        _.set(binds, 'periodtwo', last_date.workdate)

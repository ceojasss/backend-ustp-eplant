 ...
 */
const detailQuery = ` select rowid "rowid", empcode "empcode",gangcode "gangcode", get_empname(empcode) "empname", empcode_lf "empcode_lf",get_empname(empcode_lf) "empname" ,to_char(TDATE, 'dd-mm-yyyy') "tdate",

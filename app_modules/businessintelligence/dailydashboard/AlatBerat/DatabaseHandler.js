...
from EPMS_USTP.vehicleavailability_consol where tdate = to_date(:p_date,'dd-mm-yyyy') and vehiclegroupcode in ('DT','DT20') and site = :site
`;
...
sum(decode(status,'S',1,0)) stb, 
sum(decode(status,'B',1,0)) brk 
from EPMS_USTP.vehicleavailability_consol where tdate = to_date(:p_date,'dd-mm-yyyy') and vehiclegroupcode in ('DT','DT20')
`

...
async function getDetailLimit(req, res, next) {
    ...
    const last_date = _.maxBy(checkEntry.rows, function (o) { return o.tanggal_date.getDate() })

    const dateList = _.map(checkEntry.rows, function (o) { return o.tanggal })
 
    let binds = { ...req.query }
// console.log(binds)
// console.log(last_date)
    _.set(binds, 'period', last_date.tanggal)
// console.log(binds)

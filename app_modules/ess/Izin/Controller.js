 ...
 *===========================================================================*/
 ...
 async function post(req, res, next) {
   ...
   const tableemail = `select key_leave, id_leave from hr_short_leave where id_leave in (select max(id_leave) from hr_short_leave where empcode = '${req.user.empcode}' and approvedby1 is null)`

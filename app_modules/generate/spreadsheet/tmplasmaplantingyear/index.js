 ...
 *===========================================================================*/
 ...
 async function get(req, res, next) {
     ...
     let responseResult, secondresponseResult;
 
     let RB_LABEL = [];
 
     try {
         // template 
         const filename = await setReportName(req, res, `MaturePlantingYearPlasma_${req.query.P_MONTH}-${req.query.P_MONTH2}_${req.query.P_DIV}${req.query.P_YEAR}`, DOCTYPE.XLS)

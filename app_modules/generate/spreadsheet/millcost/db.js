...
const queryStatement = ` select period,fiscalyear,jobcode,jobdescription,targetcode, description, sum(amount) as amount
from v_millcost_detail
where fiscalyear=:P_FISCALYEAR
and period between  :P_PERIOD1 and :P_PERIOD2
group by period,fiscalyear,jobcode,jobdescription,targetcode, description
order by period,jobcode`

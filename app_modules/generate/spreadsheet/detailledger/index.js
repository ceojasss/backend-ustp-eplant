...
async function get(req, res, next) {
    ...
    try {
        // template 
        const filename = await setReportName(req, res, `DetailLedger_${req.query.P_JOBCODE2}-${req.query.P_JOBCODE2}_${req.query.P_MONTH}${req.query.P_YEAR}`, DOCTYPE.XLS)
        ...
        if (_.isEmpty(responseResult)) {
            ...
            _obj.push({ data: responseResult, sheetname: 'Detail Ledger' })

 ...
 *===========================================================================*/
 ...
 async function get(req, res, next) {
     ...
     try {
         // template 
         const filename = await setReportName(req, res, `Infrastruktur_${req.query.P_IFTYPE}_${req.query.P_IFSUBTYPE}_${req.query.P_ESTATE}${req.query.P_DIVISION}`, DOCTYPE.XLS)

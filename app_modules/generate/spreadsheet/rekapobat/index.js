 ...
 *===========================================================================*/
 ...
 async function get(req, res, next) {
     ...
     try {
         // template 
         const filename = await setReportName(req, res, `LaporanRekapPengobatan_${req.query.P_JOBCODE2}-${req.query.P_JOBCODE2}_${req.query.P_MONTH}${req.query.P_YEAR}`, DOCTYPE.XLS)

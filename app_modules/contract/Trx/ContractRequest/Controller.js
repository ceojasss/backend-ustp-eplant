...
const table = ['CONTRACTREQUEST', 'CONTRACTREQUESTDETAIL']
...
async function getHA(req, res, next) {


    await HandlerDB.CheckHA(req.user, req.route.path.replace("/", ""), req.query, (error, result) => {
...
module.exports.getHA = getHA;

async function getHectPlanted(req, res, next) {


    await HandlerDB.HectPlanted(req.user, req.route.path.replace("/", ""), req.query, (error, result) => {
...
module.exports.getHectPlanted = getHectPlanted;
...
async function post(req, res, next) {
    ...
    const document = req.user.loginid.match(/^.*HO$/)?'CONTRACT REQUEST HO':'CONTRACT REQUEST'

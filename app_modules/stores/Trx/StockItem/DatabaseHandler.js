...
where parametercode='EPMS106' and valuation_method = parametervaluecode and stockgroupcode = groupcode and uo.unitofmeasurecode= uomcode and itemtype = '0'
and (itemcode LIKE UPPER ('%' || :search || '%')
    OR itemdescription LIKE UPPER ('%' || :search || '%')
    OR stockgroupcode LIKE UPPER ('%' || :search || '%')

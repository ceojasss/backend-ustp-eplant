...
async function update(req, res, next) {
    ...
    const binds = req
    try {
        await dbhandler.updateData(table, req.user, req.body, binds).then(result => {
        ...
        }).catch(error => res.status(200).json({ 'error': error.message, 'detail': error.stack }));
